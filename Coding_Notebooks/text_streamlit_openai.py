...
st.set_page_config(page_title="AIDCORE", layout="wide")

st.markdown("""
### Document Genie: Get instant insights from your Documents

This chatbot is built using the Retrieval-Augmented Generation (RAG) framework, leveraging OpenAI's GPT-3.5. It processes uploaded PDF documents by breaking them down into manageable chunks, creates a searchable vector store, and generates accurate answers to user queries. This advanced approach ensures high-quality, contextually relevant responses for an efficient and effective user experience.

### How It Works

Follow these simple steps to interact with the chatbot:

1. **Enter Your API Key**: You'll need an OpenAI API key for the chatbot to access OpenAI's models. Obtain your API key [here](https://platform.openai.com/account/api-keys).
...
def main():
    ...
    with st.sidebar:
        ...
        if st.button("Generate Recommendation Email", key="email_recommendation_button"):
